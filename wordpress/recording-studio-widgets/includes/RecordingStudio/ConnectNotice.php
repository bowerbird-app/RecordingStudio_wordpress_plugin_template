...
final class ConnectNotice {
	...
	private const ENTRIES = array(
		...
		self::PROBE_FAILED              => array( 'error', 'The host did not accept those API keys. Check the URL and Advanced fields.' ),
		...
		self::CONNECT_FAILED            => array( 'error', 'Could not connect. Check the host URL and client id.' ),
		self::DISCONNECTED              => array( 'success', 'Disconnected. Embeds will use Advanced API keys if you saved them.' ),
		self::INVALID_CLIENT            => array( 'error', 'That client id is not for this host. Paste the public WordPress Plugin Demo id.' ),
		self::REDIRECT_URI_MISMATCH     => array( 'error', 'This WordPress address is not registered yet. Add the exact callback URL in Registered apps.' ),
