...
- This repository is the RecordingStudio WordPress widgets addon. The Rubygems name stays `recording_studio_wordpress_plugin_template`.
- Preserve engine namespace isolation under `RecordingStudioWordpressPluginTemplate`.
