...
| Tailwind styles missing | Run `bin/rails recording_studio_root_switchable:link_tailwind_sources` then `bin/rails tailwindcss:build`. Confirm `vendor/flat_pack` exists under the dummy app. |
