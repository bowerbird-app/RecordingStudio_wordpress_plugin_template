...
1. Click **Login**. There is no host URL field and no client id field. Login starts Connect.
...
4. Settings **Login** completes after Users sign-in, or Advanced **Test connection** succeeds.
