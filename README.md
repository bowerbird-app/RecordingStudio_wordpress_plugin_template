...
- `/` home, `/docs/recordings_tree`, `/admin/screens/oauth_clients` (**Registered apps**, signed-in), and `/recording_studio_api/api_clients` (**API Keys**, signed-in) are the dummy sidebar destinations
