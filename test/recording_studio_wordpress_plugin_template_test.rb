...
class RecordingStudioWordpressPluginTemplateTest < Minitest::Test
  ...
  def test_version_matches_release
    assert_equal "0.4.24", ::RecordingStudioWordpressPluginTemplate::VERSION
  end
  ...
  def test_dummy_gemfile_pins_verified_4x_github_tags
    ...
    assert_includes gemfile, 'github: "bowerbird-app/RecordingStudio_Oauth", tag: "v0.4.2"'
    lockfile = File.read(File.expand_path("dummy/Gemfile.lock", __dir__))
    assert_includes lockfile, "recording_studio_oauth (0.4.2)"
  ...
  def test_product_readme_is_the_template_guide
    ...
    assert_includes readme, "dummy GitHub tag `v0.4.2`"
